export function VerifiedBadge({ className = "verified-badge" }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 256 256"
